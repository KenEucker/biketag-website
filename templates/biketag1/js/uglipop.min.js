...
;(function (w, doc) {
    ...
    function init() {
        ...
        content_fixed.setAttribute(
            'style',
            'position:fixed;top: 50%;left: 50%;transform: translate(-50%, -50%);-webkit-transform: translate(-50%, -50%);-ms-transform: translate(-50%, -50%);opacity:1;',
        )
    ...
    function uglipop(config) {
        if (config) {
            ...
            if (config.keepLayout && !config.class) {
                doc.getElementById('uglipop_popbox').setAttribute(
                    'style',
            ...
            if (typeof config.content == 'string' && config.content && config.source == 'div') {
                doc.getElementById('uglipop_popbox').innerHTML = doc.getElementById(
                    config.content,
                ).innerHTML
            }
        }
