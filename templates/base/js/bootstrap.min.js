...
!(function (t, e) {
    ...
    Q.on(
        ...
        Q.on(window, 'load.bs.carousel.data-api', function () {
            for (var t = V.find('[data-bs-ride="carousel"]'), e = 0, n = t.length; e < n; e++)
            ...
            return (
                ...
                (n.show = function () {
                    ...
                    if (!this._isTransitioning && !this._element.classList.contains('show')) {
                        ...
                        this._parent &&
                            0 ===
                                (n = V.find('.show, .collapsing', this._parent).filter(function (
                                    e,
                                ) {
        ...
        mt = (function (e) {
            ...
            return (
                ...
                (i.dropdownInterface = function (t, e) {
                    ...
                    if (
                        (n || (n = new i(t, 'object' == typeof e ? e : null)), 'string' == typeof e)
                    ) {
                ...
                (i.clearMenus = function (t) {
                    if (!t || (2 !== t.button && ('keyup' !== t.type || 'Tab' === t.key)))
                        for (
                            var e = V.find('[data-bs-toggle="dropdown"]'), n = 0, o = e.length;
                            n < o;
                            n++
                        ) {
        ...
        bt = (function (t) {
            ...
            return (
                ...
                (n._resetScrollbar = function () {
                    V.find('.fixed-top, .fixed-bottom, .is-fixed, .sticky-top').forEach(function (
                        t,
                    ) {
                        var e = q.getDataAttribute(t, 'padding-right')
                        void 0 !== e &&
                            (q.removeDataAttribute(t, 'padding-right'), (t.style.paddingRight = e))
                    }),
            ...
            return (
                ...
                (a.hide = function () {
                    ...
                    if (this._popper) {
                        ...
                        if (
                            !Q.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented
                        ) {
                            var i
                            if (
                ...
                (a.setContent = function () {
                    ...
                    this.setElementContent(V.findOne('.tooltip-inner', t), this.getTitle()),
                        ...
                        return 'object' == typeof e && g(e)
                            ...
                            : void (this.config.html
                                  ? (this.config.sanitize &&
                                        (e = kt(e, this.config.allowList, this.config.sanitizeFn)),
                                    (t.innerHTML = e))
                                  : (t.textContent = e))
                }),
                (a.getTitle = function () {
        ...
        Ut = (function (t) {
            ...
            return (
                ...
                (n._getConfig = function (t) {
                    if (
                        'string' !=
                            typeof (t = s({}, Kt, 'object' == typeof t && t ? t : {})).target &&
                        g(t.target)
                    ) {
                        var e = t.target.id
                ...
                (n._activate = function (t) {
                    ...
                    n.classList.contains('dropdown-item')
                        ? (V.findOne('.dropdown-toggle', n.closest('.dropdown')).classList.add(
                              'active',
                          ),
        ...
        return (
            (n.show = function () {
                ...
                if (
                    ...
                    var s = null
                    if (
                        (e && (s = Q.trigger(e, 'hide.bs.tab', { relatedTarget: this._element })),
                        !(
